...
/**
 * Given an object containing all the required com.codeup.demo.data for a given page, fetch all the needed com.codeup.demo.data and return it as properties to pass to a view.
 * @param state
 * @param request
 * @returns {Promise<{}>}
 */
